/* ========================================================
    DIRECCIÓN DEL ARCHIVO: frontend/assets/app.js
    Lógica del Dashboard, Gestión de Temas y API
   ======================================================== */
...
function setupTheme() {
    ...
    // Cargar tema preferido guardado
    const savedTheme = localStorage.getItem('mfc_theme') || 'tech';
        ...
        rows.forEach(u => {
            ...
            tbody.innerHTML += `
                <tr>
                    ...
                    <td><span class="badge">${u.estado || 'ACTIVO'}</span></td>
                </tr>
            `;
        });
...
(function init() {
    fillUserUI();
    setupInteractions();
    setupTheme(); // Activa el selector de colores
